...
const companies = document.querySelectorAll('.main-content__choiceBrands .swiper-slide:nth-child(n + 9)');
...
document.addEventListener('click', event => {
  ...
  } else if (event.target.matches('.feedback-popup__clouse-btn') || event.target.matches('.feedback-popup-click-outside')) {
...
document.addEventListener('click', event => {
  ...
  } else if (event.target.matches('.call-popup__clouse-btn') || event.target.matches('.call-popup-click-outside')) {
...
document.addEventListener('click', event => {
  ...
  } else if (event.target.matches('.menu-popup__close-btn') || event.target.matches('.menu-popup__click-outside')) {
